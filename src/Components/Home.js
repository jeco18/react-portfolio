        ...
        <div className="w-11/12 mx-auto lg:w-10/12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
                <div className='pt-12 text-center order-last md:text-start md:order-first md:pt-40 lg:pt-52 lg:order-first'>
                    ...
                    <button className='rounded bg-black text-white px-8 py-2 mt-6 hover:bg-[#171717]'><a href='https://drive.google.com/file/d/1h62zEF6daekagnsIVCiDU00w84Tu9hKF/view?usp=sharing' target="_blank" rel="noreferrer">Resume</a></button>
                </div>
